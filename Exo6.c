// pour compiler ce fichier executer gcc Exo6.c O9 -o Exo6 -std=c99

// pour executer faire : ./Exo6 degreMon_Fichier.txt
...
#define nbarete 100000000 //a adapter au fichier
